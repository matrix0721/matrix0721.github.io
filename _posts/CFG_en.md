...
At first, diffusion models are trained without any conditions or labels. To generate images belong to specific classes, Dhariwal P et al. [2] proposes classifier guidance to guide the model to generate images with specific classes.
...
First, CFG may lead to distribution that impossible to be generated by the denoising process. Second, CFG may cause over-enhancement of the condition $c$, leading to oversaturated images.
...
![1737453609076](image/CFG_en/1737453609076.png)
...
![1737473006172](image/CFG_en/1737473006172.png)
